...
<div class="banner">
    ...
    <h1 class="banner-header">Go Sterling!</h1>
</div>
<style>
    .banner {
        position: relative;
    ...
    .banner-header {
        ...
        background-color: transparent; /* Set the background color with some transparency */
...
query = st.text_area("Ask a question about the document", on_change=clear_submit, value="Generate an email to a customer with a few offers he is qualified for. " + st.session_state['summary_output'])
